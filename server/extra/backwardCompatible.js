const xb360ToOne = require('./backwardComp/Xbox360ToXboxOne.json');
const xboxTo360 = require('./backwardComp/XboxToXbox360.json');
const xboxToOne = require('./backwardComp/XboxToXboxOne.json');
